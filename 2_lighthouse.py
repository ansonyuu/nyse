...
for index in random_indices:    
    ...
    stream = subprocess.run(f'lighthouse {str(urls[index]).strip()} --only-categories=accessibility --quiet --output=json --chrome-flags="--headless', stdout=subprocess.PIPE, shell=True)
